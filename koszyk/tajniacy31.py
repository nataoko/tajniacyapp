...
#menu: instrukcja, o autorze, nowa gra
#po zakończeniu rundy dodć powrót do menu
...
def game_loop(scoreboardredSprite, scoreboardblueSprite):
    ...
    while running:
        ...
        kursorSprite.clear(screen, background_image)
        ...
        if INTRO == 2: #miejsce na menu
            ...
            #kartaSprites.clear(screen, loadImage("bkg_new_game.jpg"))   
