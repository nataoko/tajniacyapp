...
# dodac zmienne globalne, zebynie otwierac plikow milion razy
#
...
#poco = input("wpisz nazwe:")
    ...
    screen.blit(loadImage("bkg_t.jpg"),(0,0)) #dodaje tło

    # kursor
    kursor = Kursor()
    #screen.blit(kursor,pygame.mouse.get_pos())
...
def odczyt(file):
    ...
    myfont = pygame.font.SysFont("monospace", 20,bold = 1)
    i=0
...
def game_loop(scoreboardredSprite, scoreboardblueSprite):
    
    
    running = True
    INTRO = 2
    kartaSprites = pygame.sprite.RenderClear() #init kart do menu
    kursorSprite = pygame.sprite.RenderClear()
    ...
    while running:
        ...
        if INTRO == 2: #miejsce na menu
            ...
            kartaSprites.update() #uaktualnia 
            kartaSprites.draw(screen) #dodaje
        ...
        if nowa_gra.counter == 2 or menu_nowa_gra.counter == 2:
            menu_instrukcja.open = 0
            menu_o_autorze.open = 0
            kursor.background_image = loadImage("bkg.jpg")
            screen.blit(loadImage("bkg.jpg"),(0,0)) 
        ...
        #kursorSprite = pygame.sprite.RenderClear()
        #kursorSprite.clear(screen, kursor.image)
...
class Kursor(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.background_image = loadImage('bkg_t.jpg')
    def update(self):
...
if __name__ == '__main__':
    ...
    game_loop(scoreboardredSprite, scoreboardblueSprite)
