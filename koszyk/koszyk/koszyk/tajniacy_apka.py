#okno z kartami 25 z haslami z slowa25
#po najechaniu na karte, zmienia sie kolor
#po kliknieciu zmienia na kolor druzyny [badx obrazek ladny]
#kursor to reka
...
class ScoreBoardRed(pygame.sprite.Sprite):
    def __init__(self, czy_dominuje = 1):
        #inicjalizuj klasę bazową
        pygame.sprite.Sprite.__init__(self)
        self.score = 0
...
class ScoreBoardBlue(pygame.sprite.Sprite):
    def __init__(self, czy_dominuje = 0):
        #inicjalizuj klasę bazową
        pygame.sprite.Sprite.__init__(self)
        self.score = 0
        self.pkty = 8+czy_dominuje
...
if __name__ == '__main__':
    ...
    ##    muchaCounter += 1
    ##    if muchaCounter >= 200:
    ##        muchaSprites.add(Mucha(320))
    ##        muchaCounter = 0

    ##    #Aktualizuj wszystkie sprite'y
    ##    frogSprite.update()
    ##    frog1Sprite.update()
    ##    bocianSprites.update()
    ##    muchaSprites.update()

    ##    #Sprawdź, czy żaba zostala zjedzona
    ##    for hit in pygame.sprite.groupcollide(frogSprite,bocianSprites,1,0):
    ##        bocianFX.play()
    ##        frog = Frog() #stwórz żabę
    ##        frogSprite.add(frog)                #dodaj go do grupy
    ##        lifesboardSprite.update()
    ##        lifesboardSprite.clear(screen, background_image)
    ##        lifesboardSprite.draw(screen)
    ##        pygame.display.flip()
    ##        lifes-=1
    ##        if lifes==0:
    ##            rewrite(score)
    ...
    ##            lifes=3
    ##
    ##            scoreboardSprite.remove(scoreboard)
    ##            scoreboard=ScoreBoard()
    ##            scoreboardSprite.add(scoreboard)
    ##            scoreboardSprite.clear(screen, background_image)
    ##            scoreboardSprite.draw(screen)
    ##
    ##            lifesboardSprite.update(-3)
    ##            lifesboardSprite.clear(screen, background_image)
    ##            lifesboardSprite.draw(screen)
    ##            pygame.display.flip()
    ##
    ##            #Wyczyść ekran
    ##            bocianSprites = pygame.sprite.RenderClear()
    ##            muchaSprites=pygame.sprite.RenderClear()
    ##            bocianSprites.add(Bocian(150))
    ##            bocianSprites.add(Bocian(450))
    ##            bocianSprites.add(Bocian(650))
    ##            muchaSprites.add(Mucha(150))
    ##            muchaSprites.add(Mucha(450))
    ##            muchaSprites.add(Mucha(650))
    ##                    
    ##            INTRO=1
    ##            
    ##
    ##    #Sprawdź, czy mucha została zjedzona
    ##    for hit in pygame.sprite.groupcollide(frogSprite,muchaSprites,0,1):
    ##        frogFX.play()
    ##        score+=1
